...
public class OwnerTests {
  ...
  @Test
  void testFindOwnersSuccess(Vertx vertx, VertxTestContext testContext) throws Throwable {
  ...
  @Test
  void testFindOwnersByLastNameSuccess(Vertx vertx, VertxTestContext testContext) throws Throwable {
    client.get(PORT, HOST, "/owners")
